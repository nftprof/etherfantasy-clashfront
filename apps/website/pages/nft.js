...
<section class="slab"><div class="wrap">
  ...
  <p><strong>DNA claims</strong> are earned through ongoing $CT spending across the Ether Fantasy games, with priority weighted by regional concentration — regions with fewer active players have an advantage.</p>
  <p><strong>Summoning costs — gold + wood + fur + iron</strong>, scaling with blueprint rarity and biome match. Non-native summons pay a premium; rare mythic blueprints need heavier ceremony (rare metal, iron harness). Full breakdown in the <a href="/economy.html#reference-tables">economic reference tables</a>.</p>
</div></section>
...
<section class="slab"><div class="wrap">
  ...
  <p><strong>Equipped signature artifacts grant an elemental aura</strong> — the mechanic that lets Masters (who are element-free themselves, per canon) shape element strategy. Equip a Flame Scimitar, and all Fire-species soldier stacks in your Master's army fight at +10% while she's alive. Non-matching elements get nothing; the aura stacks with weather + terrain in the same ±35% affinity cap. Legendary Singulars may bump the aura higher. See <a href="/masters.html">Masters</a>.</p>
