...
<section class="slab"><div class="wrap">
  <h2>Evolution — the elite gate</h2>
  <p>Every pet species has a <strong>Form</strong>. Form 1 is the base; Form 2, 3, and 4 are evolutions.</p>
  <ul>
    <li><strong>Form 1 (any pet)</strong> — deployable as LINE units in your armies. Populace-drafted, cheap, always available.</li>
    <li><strong>Form 2+ (evolved species)</strong> — the <strong>only</strong> path to ELITE units. Requires a crafted arm from your Workshop + gold + fur + the evolved pet species. Form 1 pets are line-only forever, no shortcut.</li>
    <li><strong>Mythic rarity</strong> — neither line nor elite. Special reinforcement mechanic — see <a href="/masters.html">Masters page</a>.</li>
  </ul>
  <p>This is why evolved-pet NFT blueprints are premium value. It's why <a href="/economy.html#reference-tables">wild-spawn evolution</a> becomes a real strategic reason to enrich frontier land — the wild eventually spawns the evolved forms you need for your elites. It's why boss lairs feed the DNA-fragment economy.</p>
</div></section>
